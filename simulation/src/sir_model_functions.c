...
void SIR_CVODES(double results_y[][g_inpset->num_out_cvodes], double results_s[][g_inpset->num_out_cvodes][2 + g_inpset->num_basis_spline], double state_params[2 + g_inpset->num_basis_spline],
...
//                 double degree, double m, double nf, double *knots, double *basis, char *sensitivity_parameters[])
{
  ...
  int sensi_meth;
  //double results_s[NEQ][g_inpset->num_out_cvodes][2 + g_inpset->num_basis_spline];
  realtype *s_data;
