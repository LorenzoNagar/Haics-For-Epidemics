...
//void fnAssignNICOMP(int NICOMP, char type_model);//use for SIR/SEIR models
int fnAssignNICOMP(char *type_model);//use for SIR/SEIR models
int ReadInput(char *input);//use in main.c
